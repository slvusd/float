...
class MS5837(object):
    ...
    def auto_detect_model(self):
        sensitivity = self._C[1]
        if MS5837_30BA_MIN_SENSITIVITY <= sensitivity <= MS5837_02BA_30BA_SEPARATION:
            self._model = MODEL_30BA
        elif MS5837_02BA_30BA_SEPARATION < sensitivity <= MS5837_02BA_MAX_SENSITIVITY:
    ...
    def _calculate(self):
        ...
        if self._model == MODEL_02BA:
            ...
            if (self._temperature / 100) < -15:
                ...
                OFFi  = (self._temperature - 2000) * (self._temperature - 2000) / 16
                SENSi = 0
        OFF2  = OFF  - OFFi
        SENS2 = SENS - SENSi
        if self._model == MODEL_02BA:
